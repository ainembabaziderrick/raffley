...
wildlife =
  %Charity{name: "Wildlife Refuge", slung: "wildlife-refuge"}
  |> Repo.insert!()

food =
  %Charity{name: "Food Pantry", slung: "food-pantry"}
  |> Repo.insert!()

hope =
  %Charity{name: "Homes of Hope", slung: "homes-of-hope"}
  |> Repo.insert!()

grace =
  %Charity{name: "Grace Foundation", slung: "grace-foundation"}
  |> Repo.insert!()
